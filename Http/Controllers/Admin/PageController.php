...
class PageController extends AdminBaseController
{
     ...
     * @return Response
     */
    public function edit(Page $page, FileRepository $fileRepository)
    {
        $this->assetPipeline->requireJs('ckeditor.js');
        $this->assetPipeline->requireCss('icheck.blue.css');

        $featured_image = $fileRepository->findFileByZoneForEntity('featured_image', $page);

        return view('page::admin.edit', compact('page', 'featured_image'));
    }
